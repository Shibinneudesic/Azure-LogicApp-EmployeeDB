-- ====================================================
-- LocalDB SQL Server - Employee Table Creation Script
-- ====================================================
-- This script creates the Employee table for local development
-- using LocalDB SQL Server Express.
...
PRINT 'Employee table and related objects created successfully in LocalDB!';
PRINT 'Sample data inserted for testing.';
PRINT 'Database ready for Logic App development and testing.';